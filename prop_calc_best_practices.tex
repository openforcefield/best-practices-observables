...
\todo{Ensure torsions are adequately sampled, both in gas and liquid. This has been found to be an issue for e.g. the hydrogen syn/anti conformation of carboxylic acids.}
...
\subsubsection{Heats of vaporization}
\begin{enumerate}
\item Ensure torsions are adequately sampled, both in gas and
  liquid. This has been found to be an issue for e.g. the hydrogen
  syn/anti conformation of carboxylic acids.
\item Ensure constraints (e.g. SHAKE of R-H bonds) are set as
  desired, as turning on SHAKE for R-H bonds has been found to
  yield differences in DH computed of several kcal/mol, despite making
  this change consistently in both the gas and liquid phases.
\item Just as a note: we should check for time-step dependence.
\end{enumerate}
